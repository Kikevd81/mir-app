...
async function inspectListadosM() {
  console.log('🚀 Inspecting listados/M endpoint...');
  ...
  try {
    ...
    const url = 'https://fse.sanidad.gob.es/hera/api/datos/convocatoria/getPlazasAdjudicadas/listados/M';
